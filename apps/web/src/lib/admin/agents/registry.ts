...
export const AGENT_REGISTRY: Record<AgentId, AgentDescriptor> = {
  ...
  costar_market_data: {
    ...
    name: "COSTAR Admin Agent",
    shortName: "COSTAR Admin",
    tier: 1,
    status: "manual_mode",
    statusLabel: "Configured · Manual",
    workspace: "services/costar/",
    purpose:
      "Maintain the institutional hospitality market WAREHOUSE — country / market / submarket / class time-series. Slow-cadence, batch-style, warehouse-oriented. Does NOT manage hotel-specific compsets (that is the CompSet Builder).",
    mission:
      "Own the institutional hospitality warehouse for HOTELVALORA. Country / Market / Submarket / Class KPIs across hospitality (supply · demand · occupancy · ADR · RevPAR · pipeline). The substrate every underwriting decision rests on.",
    responsibilities: [
    ...
    currentMode:
      "Configured but not operational yet — manual uploads during MVP; CoStar subscription not yet economically justified",
    lastExecution: null,
    nextExecution: null,
    healthScore: 100,
    successRate: "—",
