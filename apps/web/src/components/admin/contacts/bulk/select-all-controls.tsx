...
/**
 * Toolbar above the table: select-this-page · select-filtered-set ·
 * clear. Always rendered (even when no selection) so the operator can
 * fan out / fan in fast.
 */
export function SelectAllControls({ pageIds, filteredTotal }: { pageIds: string[]; filteredTotal: number }) {
