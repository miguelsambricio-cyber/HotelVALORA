...
/**
 * Canonical Financials INDEX page. Reads `params.reportId` and builds
 * sub-page hrefs preserving the report context. The static `/report/financials`
 * sibling is a legacy bridge that bootstraps or 308s here.
 *
 * Without this file, sidebar nav to the "5. Financials" parent inside a
 * canonical report would 404 (no page at the [reportId]/financials level).
 */
export default function FinancialsLandingPage({ params }: PageProps) {
  ...
  const SUB_PAGES: FinancialsSubPage[] = [
    ...
    {
      href: `/report/${reportId}/financials/pl`,
      title: "P&L 5 Years",
      blurb:
