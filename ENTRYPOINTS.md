...
| **Phase 4 canonical-backed reports** (Executive Summary + Asset Analysis · canonical-reader joins hotel_canonical + market + submarket + operator · per-section mappers · `?canonical_id=` AND `?hotel_id=h_<hex>` route resolution · mock fallback preserved) | `apps/web/src/lib/report/canonical-reader.ts` + `apps/web/src/lib/report/canonical-mappers/{executive-summary,asset-analysis}.ts` + `apps/web/src/app/report/{executive-summary,asset-analysis}/page.tsx` |
