...
| Service | Phase |
|---|---|
| Data Ingestion Agent — `services/transactions/` workspace supervision (parse INPUT_*, normalise, dedup, append MASTER, archive to old.*) | Phase 2.3.b — workspace scaffold live, agent wiring deferred |
